...
namespace Player
{
    ...
    public class PlayerController : GenericSingletonClass<PlayerController>, IDestroyInstance
    {
        ...
        private void RotateCameraFromInput()
        {
            ...
            _rotationX += -rot.y * (playerScriptable.sensibility * OptionsDDOL.Instance.sensibility);
            ...
            transform.rotation *= Quaternion.Euler(0, rot.x * (playerScriptable.sensibility * OptionsDDOL.Instance.sensibility), 0);
        }
