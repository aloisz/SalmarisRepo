...
namespace AI
{
    ...
    public class SO_IA : ScriptableObject
    {
        ...
        [field:SerializeField] internal string poolingName{ get; private set; }
        ...
        [field: Range(0, 300)][field:SerializeField] internal float gravityApplied { get; private set; }
        
        
        [field: Header("Health Module")] 
        [field: Range(0, 500)][field:SerializeField] internal float health { get; private set; }
        [field: Range(0, 10)][field:SerializeField] internal float knockoutTime { get; private set; }
